...
git clone https://github.com/HadiSkr/Full-Stack-eCommerce-Website-and-Dashboard.git
    ...
    Import the MySQL database files located in the Website/Mysql Files directory.
    ...
    Import the MySQL database files located in the Dashboard/Mysql Files directory.

Once the installation is complete, you should be able to accessthe E-commerce website and dashboard by opening the respective URLs in your web browser.

Please note that the installation steps may vary depending on your specific environment and configuration. Make sure to carefully read the README files in the Website/Frontend, Website/Backend, Dashboard/Frontend, and Dashboard/Backend directories for detailed instructions on setting up the frontend and backend components.
